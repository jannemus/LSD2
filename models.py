...
class modelsClass(object):
    ...
    # This ensures that the network works with images of arbitrary size.
    def addPadding(self, layer, level):
    ...
    def LSD2(self):
        ...
        input_long = Input((self.img_rows, self.img_cols,3))
        input_short = Input((self.img_rows, self.img_cols,3))
        
        inputs = concatenate([input_long,input_short])
        ...
        model = Model(inputs=[input_long,input_short], outputs=conv10)
